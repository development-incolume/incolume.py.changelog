...
This file was automatically generated for [incolume.py.changelog](https://github.com/development-incolume/incolume.py.changelog/-/tree/0.7.0a7)
...
### Added
  ...
  - Adcionado badges de `wheel` e `stable`;
### Changed
