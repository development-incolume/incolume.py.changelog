...
This file was automatically generated for [incolume.py.changelog](https://github.com/development-incolume/incolume.py.changelog/-/tree/0.18.0a1)
...
### Added
  - Tradução do arquivo COVENTIONAL_COMMITS.md para outros idiomas;
